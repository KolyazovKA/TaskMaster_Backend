...
SECRET_KEY = 'django-insecure-51s79^#&0ds5etwhwq8ny$kz&5j@y*0k!$r*lszd6jn$kdji@_'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '192.168.1.248']
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',  # Например, ваш фронтенд
    'https://example.com',
]
